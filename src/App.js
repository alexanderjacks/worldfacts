      ...
      <div className="App">
        <header className="App-header">
          ...
          <p className="font-bold black-text">
            Below are some examples of my design, development, and deployment chops.<br/><a href="mailto:alexdjacks@gmail.com">Email me for more details.</a>
          </p>
        </header>
        <Projects/>
      </div>
